...
class Portfolio:
	...
	def __init__(self,currency_list = ["USD","BTC","ETH","ZEC"], default_currency = "USD",init_value = 100.0):
		print("creating portfolio")

		self.currencys = currency_list
		self.default_currency = default_currency

		self.holding = dict.fromkeys(self.currencys, 0.0)
		...
		self.prices[self.default_currency + "-" +  self.default_currency]=1.0
